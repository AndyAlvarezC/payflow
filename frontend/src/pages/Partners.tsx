...
export default function Partners() {
  return (
    <section
      id="partners"
      className="flex text-center m-auto min-h-screen md:min-h-2/3 pt-16 md:pt-48 w-full"
    >
      <div className="w-full md:px-35">
        ...
        <div className="grid grid-cols-2 md:flex pt-8 gap-10 m-auto w-[80%] md:w-full md:pt-16">
          <PartnersCard logo={<Visa />} />
          <PartnersCard logo={<Mastercard />} />
          <PartnersCard logo={<Paypal />} />
          <PartnersCard logo={<Stripe />} />
          <PartnersCard logo={<Applepay />} />
          <PartnersCard logo={<Googlepay />} />
        </div>
