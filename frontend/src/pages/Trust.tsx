...
export default function Trust() {
  return (
    <section className="flex text-center m-auto min-h-screen pt-16 w-full">
      <div className="w-full md:px-35 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-center">
          <div>
            ...
            <p className="mt-2">Usuarios activos</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-gray-200">2M+</h3>
            <p className="mt-2">Transacciones procesadas</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-gray-200">99.9%</h3>
            <p className="mt-2">Tiempo en línea</p>
          </div>
        </div>

        <div className="w-[80%] mt-12 flex justify-center m-auto gap-6">
          <CardTrust
